...
ARCH		?=arm64
CROSS_COMPILE	?=~/android/toolchain/clang-llvm/bin/aarch64-linux-android-
...
CC              = ~/android/toolchain/clang-llvm/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
CLANG_TRIPLE    ?= ~/android/toolchain/clang-llvm/bin/aarch64-linux-gnu-
